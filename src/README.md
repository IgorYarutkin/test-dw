...
```javascript
tars init --exclude-html --exclude-css --silent --source http://gitolite.digitalwand.ru/a.kosyanenko/tars/repository/archive.zip?ref=custom
```
...
```javascript
tars update-project --exclude-html --exclude-css --source http://gitolite.digitalwand.ru/a.kosyanenko/tars/repository/archive.zip?ref=custom
```
